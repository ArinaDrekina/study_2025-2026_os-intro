...
author: Отчет о выполнение внешнего курса, второй блок
...
на практике основные принципы работы с POSIX-совместимыми операционными	системами.
Однако самым важным итогом стал полученный сертификат об окончании моих страданий.
